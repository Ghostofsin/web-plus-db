...
async function loadfacts() {
  const res = await fetch(
    "https://nuxlfhwlldytqsjrqngc.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im51eGxmaHdsbGR5dHFzanJxbmdjIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODU5NzYzMDksImV4cCI6MjAwMTU1MjMwOX0.eOhcx7lv1y2zi5-RSf7qYXHGnNnbnZ7uUAbnjw9aDE0",
      },
    }
  );
...
btn.addEventListener("click", function () {
  if (form.classList.contains("hidden")) {
    ...
    btn.textContent = "Share the fact";
  }
});
